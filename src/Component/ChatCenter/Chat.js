...
const Chat = (props) => {
  ...
  const arraychatbot = [{ message: value }];

  const handleclick = () => {
    const oneMessage = [...message];
    oneMessage.push({ message: value });
    setMessage(oneMessage);

    console.log("message : ", oneMessage);
    // arraychatbot.push({ message: value });
  };
    ...
    <div>
      <div className="ChartCard1">
        ...
        <div className="profile-text">
          ...
          <h6 className="r_mail" style={{ color: "#555555" }}>
            alma.lawson@example.com
          </h6>
          <h6 className="r_phone" style={{ color: "#555555" }}>
            (270) 555-0117
          </h6>
        </div>
        ...
        {message.map((item) => {
          return (
            <div className="msg_sent">
              <div>
                <div className="message_2">
                  <p className="text_1">{item.message}</p>
