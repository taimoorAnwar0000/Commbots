        ...
        <Container fluid className="mt-3">
          ...
          <Row className="chat-bot-row2">
            <div className="chatbot-img-text">
              ...
              <div className="addbuttonpadding">
                <button
                  className="add-button"
                  style={{ background: "#32be8a4d", color: "white" }}
                >
                  <img
                    src={Add}
                    alt="Girl in a jacket"
          ...
          <div className="giving_it">
            <Row>
              <Col lg={8} md={12} sm={12} xs={12}>
                <div className="khan">
                  <div className="d-flex mt-4  chatbottext ">
                    <div className="mainbottext">
                      <h6>Main Bots</h6>
                    </div>
                    <h4 className="Linked">Linked Bots</h4>
                  </div>
                  <hr className="hr-tag" />
                  <Row>
                ...
                <div className="mobile-portion">
                  ...
                  <div className="mobile-pic">
                    <img
                      src={Mobile}
                      alt="Girl in a jacket"
                      className="chatbot-img-mobile py-1 "
                    />
                  </div>
